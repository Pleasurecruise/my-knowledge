...
Language and theme remain visible outside reading. The owner's circular expander reveals search, creation and account controls; Escape closes it. Reading places return, share and owner edit actions beside the title, without toolbar, statistics, TOC or backlinks. Icons have accessible labels; clipboard results use bottom toasts.
